...
describe("SongDetailPage layout", () => {
  ...
  it("guards ladder-derived tempo stats when a song has no BPM", () => {
    expect(source).toContain("hasWorkingBpm");
    expect(source).toContain("showLadderTempoStats");
  });
});
