    ...
    return (
      <main className="flex h-screen flex-col items-center justify-center px-6 py-10">
        ...
        <div className="mt-4 max-w-2xl text-center text-4xl font-bold text-neutral-100">
          {betweenSongs.nextSongTitle}
        </div>
        <div className="mt-10 font-mono text-8xl font-bold tabular-nums text-accent">
          {remainingSec}
        </div>
        <div className="mt-2 text-sm text-neutral-500">
          {betweenSongsPaused ? "Paused" : "seconds until next session"}
        </div>
        <div className="mt-10 flex items-center gap-3">
          <button
            type="button"
            onClick={handleBetweenSongsSkip}
          ...
          <button
            type="button"
            onClick={handleBetweenSongsPauseToggle}
          ...
          >
            {betweenSongsPaused ? "Resume" : "Pause"}
            <span className="ml-3 text-xs font-normal opacity-70">(P)</span>
          </button>
          <button
            type="button"
            onClick={handleBetweenSongsCancel}
